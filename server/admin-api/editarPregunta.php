...
try {
    ...
    $checkQuery = "SELECT id FROM preguntes WHERE id = :id";
    ...
    // Preparar la consulta d'actualització
    $query = "UPDATE preguntes SET 
                pregunta = :pregunta,
                imatge = :imatge,
                ...
                resposta_correcta_index = :resposta_correcta_index,
                activa = :activa,
    ...
    if ($stmt->execute()) {
        ...
        sendError('Error actualitzant la pregunta', 500);
    }
